root = "/home/deploy/www/helpAround_production"
working_directory root
pid "#{root}/tmp/pids/unicorn.pid"
stderr_path "#{root}/log/unicorn.log"
stdout_path "#{root}/log/unicorn.log"

listen "/tmp/unicorn.helpAround_production.sock"
worker_processes 2
timeout 40
preload_app true
...
before_exec do |server|
  ENV['BUNDLE_GEMFILE'] = "/home/deploy/www/helpAround_production/Gemfile"
end
